...
class Corpus_Card {
    ...
    _createCard() {
        ...
        let cardText_Html = `<div class="card-text"><br><strong>Source</strong>: ${this._source}, <strong>Year</strong>: ${this._year}<a href="${this._link}" target="_blank" style="color: #007DFF">, Link</a><br><br><div><strong>Description</strong>: ${this._description}</div><br><div>${this._method}</div></div>`;
